...
const AddButtonComponent = () => {
    ...
    return (
        <button onClick={AddTask} className="bg-orange-600 hover:bg-orange-700 active:bg-orange-800 fill-neutral-100 active:fill-orange-200 transition-colors px-2 py-0.5 rounded-sm font-bold text-2xl">
